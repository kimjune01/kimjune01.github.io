...
And it's fun. You build an agent, put it on the ladder, and watch it play. It does something you didn't anticipate, either disappointing or flabbergasting, and either way you're learning. That's why people got into cognitive architecture in the first place: to build something that thinks and watch it try. SC2 lets you do that every afternoon.
