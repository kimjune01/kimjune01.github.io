...
The platform has three levers: `b` (continuous weight on relevance), `τ` (hard relevance gate, the minimum cosine to enter the auction), and `λ` ([drift penalty](/synthetic-friction) preventing position gaming). This experiment tests the first two.
