...
**Link one: verifiable intent matching.** Open-weight embedding models like [Nomic](https://huggingface.co/nomic-ai/nomic-embed-text-v1.5), BGE, and GTE are publicly available. Anyone can run the same model on the same text and get the same coordinates. You can check the exchange's work yourself.
