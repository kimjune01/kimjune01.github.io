...
![A ball of fire inside a wireframe cube, sparks escaping through every face](/assets/free-as-in-fire.jpg)

[Prometheus](https://en.wikipedia.org/wiki/Prometheus) stole fire and gave it to humanity. But Zeus never got the fire back. Once given, it cannot be un-given.

The entire vector-space series is now [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). Copyleft. The openness is irrevocable.

[Transparency Is Irreversible](/transparency-is-irreversible) argued that publishing σ is a one-way gate. Once the market sees your positions, you can't fog them back up. The economics won't let you. Copyleft is the same one-way gate, enforced by law.
...
The [FCC spectrum auctions](/synthetic-friction) work because the rules are public and the spectrum is rivalrous. The embedding space works because the [math is public](/power-diagrams-ad-auctions) and the positions are rivalrous. Copyleft just ensures the rules stay public. The rest is competition.

[Richard Stallman](https://www.youtube.com/watch?v=9sJUDx7iEJw&list=RD9sJUDx7iEJw) understood this in 1983. A Xerox printer wouldn't share its source code. He built the GPL so that no one could hoard fire again. The same logic applies now: if the source is the spec, the spec must be free. Not free as in beer. Free as in fire.

[Transparency is irreversible](/transparency-is-irreversible) by economics. Copyleft makes it irreversible by law. The first lock is the market. The second lock is the license. Neither can be picked alone, and together they make enclosure structurally impossible.
