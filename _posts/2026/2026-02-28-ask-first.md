...
Every chatbot company is losing money on free users. OpenAI's inference bill is projected at [$14 billion for 2026](https://finance.yahoo.com/news/openais-own-forecast-predicts-14-150445813.html). Subscriptions have a ceiling. Advertising is the only business model that's ever scaled with free usage. Chatbot companies will run ads. The question is how to do it without destroying the trust that makes a chatbot worth using.
...
[WeChat mini-programs](https://www.tmogroup.asia/insights/wechat-mini-program-touch-points/) are the strongest precedent. They process $100 billion in annual transactions with 945 million users, and they *architecturally cannot push messages*. They can only respond when users initiate. That constraint is the reason the platform works for commerce. Users trust it because the system can't interrupt them.
