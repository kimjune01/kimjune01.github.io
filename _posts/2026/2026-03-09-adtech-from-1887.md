...
This can only work as an open protocol. The moment someone owns the signing or the verification, it's just another ad network. And it's a race: the first open standard wins on network effects, the same way HTTP did. If a proprietary version captures it first, the middleman's rent just changes hands.
