...
The exchange's batch signature is its claim to a cut. Every stamped batch is a metered facilitation event — the exchange can bill per batch, per redemption, or a flat monthly fee. How and when it collects is a [separate question](/the-recommendation-engine). What matters is the stamp proves the exchange was in the room.
