...
- **[Publisher skills](https://github.com/kimjune01/vectorspace-adserver/tree/master/skill)** instead of an SDK. Four prompt documents a coding agent reads to evaluate, install, verify, and uninstall the integration. No package dependency. The agent writes code directly into the publisher's files and opens a PR.
