import{j as s}from"./jsx-runtime.CLpGMVip.js";import{g as C,u as m,f as u,h as p,j as h,k as c,m as f,n as y}from"./util.C4W5Av6k.js";import{r as B}from"./index.B9mnsnPE.js";import{c as F}from"./cx.2dOUpm6k.js";const A=`// Koji Kondo - Swimming (Super Mario World)
stack(
  seq(
    "~",
    "~",
...
.clip(.5)
.piano()
.pianoroll()`,N=`// Hirokazu Tanaka - World 1-1
stack(
  // melody
  note(\`<
...
note(
  ...
  .gain(.5)
  .room(.5)
  .lpa(.125).lpenv(-2).v("8:.125").fanchor(.25)`,P=`// "Festival of fingers 3"
// @license CC BY-NC-SA 4.0 https://creativecommons.org/licenses/by-nc-sa/4.0/
// @by Felix Roos
...
`,X=Object.freeze(Object.defineProperty({__proto__:null,amensister:I,arpoon:Q,barryHarris:k,bassFuge:M,belldub:L,blippyRhodes:G,caverave:w,chop:K,csoundDemo:V,delay:O,dinofunk:W,echoPiano:R,festivalOfFingers:S,festivalOfFingers3:P,flatrave:U,giantSteps:x,goodTimes:j,holyflute:J,juxUndTollerei:$,loungeSponge:Z,meltingsubmarine:q,orbit:H,randomBells:T,sampleDemo:z,sampleDrums:D,sml1:N,swimming:A,undergroundPlumber:_,waa2:Y,wavyKalimba:E,zeldasRescue:v},Symbol.toStringTag,{value:"Module"}));Object.fromEntries(Object.entries(X).map(([e,a],o)=>[o,{id:o,code:a,collection:"Stock Examples"}]));function r({children:e,label:a,labelIsHidden:o,className:t,...l}){return s.jsxs("button",{className:F("hover:opacity-50 text-nowrap w-fit",t),title:a,...l,children:[o!==!0&&a,e]})}function ee({pattern:e}){const a=B.useMemo(()=>C(e.code),[e]);let o=a.title;if(o==null){const l=new Date(e.created_at);isNaN(l)?o="unnamed":o=l.toLocaleDateString()}const t=Array.isArray(a.by)?a.by.join(","):"Anonymous";return s.jsx(s.Fragment,{children:`${e.id}: ${o} by ${t.slice(0,100)}`.slice(0,60)})}function se({showOutline:e,onClick:a,pattern:o,showHiglight:t}){return s.jsx("a",{className:F("mr-4 hover:opacity-50 cursor-pointer block",e&&"outline outline-1",t&&"bg-selection"),onClick:a,children:s.jsx(ee,{pattern:o})})}function ae({patterns:e,activePattern:a,onClick:o,started:t}){const l=p(),b=h(l).id;return s.jsx("div",{className:"",children:Object.values(e).reverse().map(i=>{const n=i.id;return s.jsx(se,{pattern:i,showHiglight:n===b,showOutline:n===a&&t,onClick:()=>o(n)},n)})})}const d=(e,a,o=!1)=>{e.handleUpdate(a,o)};function oe({context:e}){const a=u(),o=p(),t=h(o),{userPatterns:l,patternFilter:g,patternAutoStart:b}=m(),i=t?.id;return s.jsxs("div",{className:"flex flex-col gap-2 flex-grow overflow-hidden h-full pb-2 ",children:[s.jsxs("div",{className:"pr-4 space-x-4  flex max-w-full overflow-x-auto",children:[s.jsx(r,{label:"new",onClick:()=>{const{data:n}=c.createAndAddToDB();d(e,n)}}),s.jsx(r,{label:"duplicate",onClick:()=>{const{data:n}=c.duplicate(t);d(e,n)}}),s.jsx(r,{label:"delete",onClick:()=>{const{data:n}=c.delete(i);d(e,{...n,collection:c.collection})}}),s.jsxs("label",{className:"hover:opacity-50 cursor-pointer",children:[s.jsx("input",{style:{display:"none"},type:"file",multiple:!0,accept:"text/plain,text/x-markdown,application/json",onChange:n=>f(n.target.files)}),"import"]}),s.jsx(r,{label:"export",onClick:y}),s.jsx(r,{label:"delete-all",onClick:()=>{const{data:n}=c.clearAll();d(e,n)}})]}),s.jsx("div",{className:"overflow-auto h-full bg-background p-2 rounded-md",children:s.jsx(ae,{onClick:n=>{d(e,{...l[n],collection:c.collection},b),e.started&&a===n&&e.handleEvaluate()},patterns:l,started:e.started,activePattern:a,viewingPatternID:i})})]})}function ie({context:e}){return m(),s.jsx("div",{className:"px-4 w-full text-foreground  space-y-2  flex flex-col overflow-hidden max-h-full h-full",children:s.jsx(oe,{context:e})})}export{r as A,ee as P,ie as a};
